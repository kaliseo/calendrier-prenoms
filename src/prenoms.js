/**
 * Calendrier des fêtes des prénoms (calendrier français traditionnel des saints).
 *
 * Clé : "MM-JJ" (mois-jour). Valeur : liste des prénoms fêtés ce jour-là.
 * Le 29 février n'est présent que les années bissextiles (géré par la récurrence annuelle).
 *
 * Ces données servent à générer un fichier .ics dont chaque événement se répète
 * chaque année (RRULE:FREQ=YEARLY).
 */
